	...
	<div class="entry-content">
		...
		the_content( sprintf(
			wp_kses(
				...
				__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'gravity-media-single-product-webshop' ),
				array(
					'span' => array(
						'class' => array(),
					),
		...
		wp_link_pages( array(
			'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'gravity-media-single-product-webshop' ),
			'after'  => '</div>',
		) );
		?>
	</div><!-- .entry-content -->
